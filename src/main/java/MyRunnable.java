...
public class MyRunnable implements Runnable {
    ...
    public MyRunnable( int i, GraphDatabaseService db, ExecutionEngine engine, long node_id1, long node_id2, String nodes_relationship ) {
        this.i = i;
    ...
    public void run() {
        try {
            ...
            System.out.println("took " + total + "ms .. processed by thread " + i);
